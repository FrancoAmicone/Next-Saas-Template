  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center px-4 py-12">
      ...
      <section className="max-w-2xl text-center mb-16">
        ...
        />
        <span className="inline-block mb-4 rounded-full bg-blue-100 px-4 py-1 text-sm font-semibold text-blue-700">OpenAI SaaS Starter</span>
<h1 className="text-4xl sm:text-5xl font-bold mb-4">Next.js SaaS Template with OpenAI</h1>
<p className="text-lg sm:text-xl text-gray-700 mb-6">
  Build and launch modern SaaS applications <span className="font-semibold text-blue-600">powered by OpenAI</span>, with authentication, subscriptions, payments, and a beautiful UI.<br />
  <span className="font-semibold text-blue-600">Integrates OpenAI</span> for generative AI features and <span className="font-semibold text-blue-600">Stripe</span> for fast, secure payments.<br />
  Ideal for launching your next SaaS product with AI in minutes.
</p>
  ...
  <div className="bg-white rounded-lg shadow p-6">
    <h3 className="font-semibold text-lg mb-2">Subscriptions & Payments</h3>
  ...
  <div className="bg-white rounded-lg shadow p-6">
    ...
    <p className="text-gray-600">Ready-to-use utilities for OpenAI API. Add generative AI features to your SaaS in minutes.</p>
  </div>
  <div className="bg-white rounded-lg shadow p-6">
  ...
  <li>
    <b>Use AI Features:</b> Users can access AI-powered features in your app, powered by OpenAI.
  </li>
  <li>
  ...
  <span className="bg-gray-100 px-4 py-2 rounded text-gray-800 font-medium">OpenAI</span>
